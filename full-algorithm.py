...
def func_modified2(regularizer_rate_0,regularizer_rate_1,num_layers_0, epochs, batch_size, num_classes, sensor_sizes, dep, xvals, yvals, reduction):
  ...
  w0=weights_0.eval()
  print(w0)
  x=func_mlp(0,0,num_layers_0, epochs, batch_size, num_classes, sensor_sizes, dep)
  ...
  if reduction==True:
    ...
    return([testacc,len(sensor_sizes)])
#%%
def func_mlp(regularizer_rate_0,regularizer_rate_1,num_layers_0, epochs, batch_size, num_classes, sensor_sizes, dep):
